...
//           <div
//             className="absolute inset-0 bg-cover bg-center transition-transform duration-500 group-hover:scale-105"
//             style={{ backgroundImage: "url('/eventBanner.png')" }}
//           />
//           <div className="absolute inset-0 bg-opacity-60 group-hover:bg-opacity-50 transition-all duration-300" />
//           <div className="relative z-10 p-8 flex flex-col justify-end h-64 text-white">
...
export default function AboutUsPage() {
  return (
    <div className="bg-gradient-to-br from-blue-50 to-green-50 min-h-screen">
      ...
      >
        {/* Blurred Background Overlay */}
        <div className="absolute inset-0 pointer-events-none backdrop-blur-[10px] bg-white/40" />

        {/* Subtle gradient overlay */}
        <div className="absolute inset-0 pointer-events-none bg-gradient-to-b from-white/50 via-transparent to-white/70" />
          ...
          >
            ...
            >
              <li>
                ...
                mobile, ML and cloud technologies.
              </li>
              <li>
                <strong>Project Labs:</strong> Mentor-driven projects that turn
                theory into deployable work.
              </li>
              <li>
                <strong>Competitions & Hackathons:</strong> Real-world
                challenges that sharpen skills and teamwork.
              </li>
            </motion.ul>
          </motion.div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
        ...
        >
          <div
            className="absolute inset-0 bg-cover bg-center transition-transform duration-500 group-hover:scale-105"
            style={{ backgroundImage: "url('/eventlogo.png')" }}
          />
